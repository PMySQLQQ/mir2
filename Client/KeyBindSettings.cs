namespace Client
{
    ...
    public class KeyBindSettings
    {
        ...
        public void New(List<KeyBind> list)
        {
            ...
            list.Add(InputKey);
            InputKey = new KeyBind { Group = "功能框", Description = "英雄背包 开/关", function = KeybindOptions.HeroEquipment, RequireAlt = 2, RequireShift = 2, RequireTilde = 2, RequireCtrl = 1, Key = Keys.C };
            list.Add(InputKey);
            ...
            list.Add(InputKey);
            InputKey = new KeyBind { Group = "英雄物品快捷栏", Description = "快捷键8", function = KeybindOptions.Belt8, RequireAlt = 2, RequireShift = 2, RequireTilde = 2, RequireCtrl = 2, Key = Keys.D8 };
            list.Add(InputKey);
            ...
            list.Add(InputKey);
            InputKey = new KeyBind { Group = "常规", Description = "灵物物品拾取", function = KeybindOptions.CreatureAutoPickup, RequireAlt = 1, RequireShift = 2, RequireTilde = 2, RequireCtrl = 0, Key = Keys.A };
            list.Add(InputKey);
            ...
            list.Add(InputKey);
            InputKey = new KeyBind { Group = "攻击模式", Description = "设置宠物模式：专注于主要目标", function = KeybindOptions.PetmodeFocusMasterTarget, RequireAlt = 2, RequireShift = 2, RequireTilde = 2, RequireCtrl = 2, Key = Keys.None };
            list.Add(InputKey);
